...
class LightingEngine {
    ...
    blackout() {
        ...
        this.fixtures.movers.forEach(addr => {
             end[addr+0] = 127; end[addr+1] = 127; end[addr+5] = 0;   
             end[addr+7] = 0; end[addr+8] = 0; end[addr+9] = 0; end[addr+10]= 0;   
        });
    ...
    sceneHell() {
        ...
        this.fixtures.movers.forEach(addr => {
             update[addr+5] = 255; // Dimmer
             update[addr+6] = 255; // Shutter
             update[addr+0] = 127; // Pan
             update[addr+1] = 127; // Tilt
             update[addr+7] = 255; // R
             update[addr+8] = 0;   // G
             update[addr+9] = 0;   // B
             update[addr+10] = 0;  // W
