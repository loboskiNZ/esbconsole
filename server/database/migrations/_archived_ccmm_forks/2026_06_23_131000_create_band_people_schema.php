...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('person_secure_fields')) {
        ...
        if (! Schema::hasTable('person_files')) {
        ...
        if (! Schema::hasTable('instrument_reference')) {
        ...
        if (! Schema::hasTable('person_instruments')) {
        ...
        if (! Schema::hasTable('person_iem_settings')) {
