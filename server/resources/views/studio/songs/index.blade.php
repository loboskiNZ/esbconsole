...
@section('content')
    <main class="esb-studio__shell relative z-10 flex min-h-dvh w-full flex-col">
        <header class="esb-studio__chrome-header">
            ...
            <h1 class="esb-portal__title">Song Library</h1>
        ...
        <div class="esb-studio__shell-body">
            ...
            <section class="esb-studio__song-library-toolbar esb-portal__panel esb-studio__card">
                <div class="esb-studio__song-library-toolbar-row">
                    ...
                    <form method="GET" action="{{ route('songs.index') }}" class="esb-studio__song-library-search">
                        @if ($showArchived)
                        ...
                        <input
                            ...
                            value="{{ $query }}"
                            placeholder="Search by code, title, reference, genre…"
                        >
            ...
            @if ($songs->isEmpty())
                <section class="esb-portal__panel esb-studio__card mt-4">
            ...
            @else
                <ul class="esb-studio__song-library-list mt-4">
