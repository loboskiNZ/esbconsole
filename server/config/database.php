    ...
    */
    ...
    'connections' => [
        ...
        */
        ...
        'recovery_source' => [
            'driver' => 'pgsql',
            'url' => env('RECOVERY_SOURCE_DB_URL'),
            'host' => env('RECOVERY_SOURCE_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('RECOVERY_SOURCE_DB_PORT', env('DB_PORT', '5432')),
            'database' => env('RECOVERY_SOURCE_DB_DATABASE', env('DB_DATABASE', 'esb_dev')),
            'username' => env('RECOVERY_SOURCE_DB_USERNAME', env('DB_USERNAME', 'root')),
            'password' => env('RECOVERY_SOURCE_DB_PASSWORD', env('DB_PASSWORD', '')),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
            'sslmode' => env('RECOVERY_SOURCE_DB_SSLMODE', env('DB_SSLMODE', 'prefer')),
        ],
